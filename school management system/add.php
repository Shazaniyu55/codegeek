...
<html lang="en">
  <head>
    ...
    <title> <?php  echo $_SESSION['admin_name']. " " . "admin page" ?></title>
...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="admin_page.php">
    ...
    <table border="1px" class="table table-striped table-hover">
        ...
        <tr>
            <th style="padding: 20px; font-size: 15px;">Firstname</th>
        ...
        <tr>
            ...
            <td style="padding: 20px;">
            <?php echo "<a href='admin_page.php?student_id={$info['id']}'>Add</a>";?>
